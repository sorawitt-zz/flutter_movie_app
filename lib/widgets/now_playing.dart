...
@override
  void initState() {
    super.initState();
    nowPlayingListBloc..getNowPlayingList();
  }

  @override
  Widget build(BuildContext context) {
    return StreamBuilder(stream: nowPlayingListBloc.subject.stream,builder: (context, AsyncSnapshot<MovieResponse> snapshot) {
      if (snapshot.hasData) {
              ...
              return Stack(children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(image: NetworkImage("https://image.tmdb.org/t/p/original/" + movies[index].backPoter),
                    fit: BoxFit.cover))
                ),
